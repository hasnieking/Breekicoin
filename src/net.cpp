...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Breekicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"breekicointools.com", "83.128.195.87"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"breekicointools.com", "testnet-seed.breekicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Breekicoin is probably already running."), addrBind.ToString().c_str());
        else
